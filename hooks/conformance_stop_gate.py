...
The plugin specifies a final compliance pass, defines seventeen criteria for it, and tells the
...
def main():
    ...
    if not reviewed:
        ...
        block(
            ...
            "every one is on disk, but nothing has checked them against the seventeen criteria.\n\n"
            "Run it now:\n"
